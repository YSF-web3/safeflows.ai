...
export default function PoolsHeatmap() {
    ...
    return (
        <div className="w-full h-full flex flex-col gap-3 border p-[18px] rounded-[13px]">
            <div className="flex justify-between items-center w-full">
                ...
                <div className="flex gap-2">
                    ...
                    <button className="h-7 border border-[#8081954D] px-2 rounded-md text-[10px] font-normal leading-4 text-black bg-[#C9F31D]">Weekly</button>
                </div>
            </div>
            <div className="grid grid-cols-9 gap-4">
                {
                    new Array(54).fill(0).map((_, i) => 
                        ...
                        :
                        <div className="size-[38px] border border-[#333333] rounded-[6px] text-[#0B0E129E]" key={i}></div>
                    )
                }
                {
                    yLabels.map((label, i) => (
