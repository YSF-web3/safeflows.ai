...
export default function AiNotifications ({poolsData }: {poolsData: Pools }) {
    ...
    return (
        ...
        >
            <div className="text-white text-xl font-medium mb-4">AI Insights</div>
            <div 
            ...
            >
                {
                    ...
                    && <div className="p-8 py-16 w-full border bg-black/30 border-white/10 rounded-xl flex flex-col items-center justify-center text-white gap-4">
                        ...
                        <button onClick={()=>{
                            ...
                            <div className="p-2 active:scale-95 hover:bg-[#C9F31D] hover:text-[black] rounded-[13px] border border-white/10 bg-[#0B0E129E] text-white text-xs font-semibold px-[21px] flex items-center transition-colors duration-200">
                            View More
                            </div>
                        </button>
                    </div>
                }
                {
                    poolsData?.message?.warnings?.map((noti, index) => (
                        <div key={index} className="lg:h-[50px] w-full border border-white/10 bg-black/30 rounded-xl flex items-center pl-[18px] pr-2 py-2">
